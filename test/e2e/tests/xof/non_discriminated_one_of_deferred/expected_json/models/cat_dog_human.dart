...
class CatDogHumanCat {
  ...
  factory CatDogHumanCat.fromJson(Map<String, dynamic> json) =>
      _$CatDogHumanCatFromJson(json);

  Map<String, dynamic> toJson() => _$CatDogHumanCatToJson(this);
}
...
class CatDogHumanDog {
  ...
  factory CatDogHumanDog.fromJson(Map<String, dynamic> json) =>
      _$CatDogHumanDogFromJson(json);

  Map<String, dynamic> toJson() => _$CatDogHumanDogToJson(this);
}
...
class CatDogHumanHuman {
  ...
  factory CatDogHumanHuman.fromJson(Map<String, dynamic> json) =>
      _$CatDogHumanHumanFromJson(json);

  Map<String, dynamic> toJson() => _$CatDogHumanHumanToJson(this);
}
