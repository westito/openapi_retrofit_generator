...
class FilePartSourceFileSource {
  ...
  factory FilePartSourceFileSource.fromJson(Map<String, dynamic> json) =>
      _$FilePartSourceFileSourceFromJson(json);

  Map<String, dynamic> toJson() => _$FilePartSourceFileSourceToJson(this);
}
...
class FilePartSourceSymbolSource {
  ...
  factory FilePartSourceSymbolSource.fromJson(Map<String, dynamic> json) =>
      _$FilePartSourceSymbolSourceFromJson(json);

  Map<String, dynamic> toJson() => _$FilePartSourceSymbolSourceToJson(this);
}
