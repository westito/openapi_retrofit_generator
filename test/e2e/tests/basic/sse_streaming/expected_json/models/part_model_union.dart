...
class PartModelUnionVariant1 {
  ...
  factory PartModelUnionVariant1.fromJson(Map<String, dynamic> json) =>
      _$PartModelUnionVariant1FromJson(json);

  Map<String, dynamic> toJson() => _$PartModelUnionVariant1ToJson(this);
}
...
class PartModelUnionVariant2 {
  ...
  factory PartModelUnionVariant2.fromJson(Map<String, dynamic> json) =>
      _$PartModelUnionVariant2FromJson(json);

  Map<String, dynamic> toJson() => _$PartModelUnionVariant2ToJson(this);
}
...
class PartModelUnionVariant3 {
  ...
  factory PartModelUnionVariant3.fromJson(Map<String, dynamic> json) =>
      _$PartModelUnionVariant3FromJson(json);

  Map<String, dynamic> toJson() => _$PartModelUnionVariant3ToJson(this);
}
