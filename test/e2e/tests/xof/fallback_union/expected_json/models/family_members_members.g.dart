...
) => FamilyMembersMembersCat(mewCount: (json['mewCount'] as num).toInt());
...
FamilyMembersMembersDog _$FamilyMembersMembersDogFromJson(
  Map<String, dynamic> json,
) => FamilyMembersMembersDog(barkSound: json['barkSound'] as String);
...
FamilyMembersMembersHuman _$FamilyMembersMembersHumanFromJson(
  Map<String, dynamic> json,
) => FamilyMembersMembersHuman(job: json['job'] as String);
