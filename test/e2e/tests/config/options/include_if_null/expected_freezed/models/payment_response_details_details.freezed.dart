...
class PaymentResponseDetailsDetailsCreditCard implements PaymentResponseDetailsDetails {
  const PaymentResponseDetailsDetailsCreditCard({required this.cardNumber, required this.expiryMonth, required this.expiryYear, required this.cvv, required this.amount, @JsonKey(includeIfNull: false) this.cardholderName, final  String? $type}): $type = $type ?? 'credit_card';
...
class PaymentResponseDetailsDetailsBankTransfer implements PaymentResponseDetailsDetails {
  const PaymentResponseDetailsDetailsBankTransfer({required this.accountNumber, required this.routingNumber, required this.amount, @JsonKey(includeIfNull: false) this.accountHolder, @JsonKey(includeIfNull: false) this.reference, final  String? $type}): $type = $type ?? 'bank_transfer';
...
class PaymentResponseDetailsDetailsCrypto implements PaymentResponseDetailsDetails {
  const PaymentResponseDetailsDetailsCrypto({required this.walletAddress, required this.cryptocurrency, required this.amount, @JsonKey(includeIfNull: false) this.transactionHash, final  String? $type}): $type = $type ?? 'crypto';
