...
class SearchResultMapper extends ClassMapperBase<SearchResult> {
  ...
  static SearchResultMapper ensureInitialized() {
    if (_instance == null) {
      ...
      SearchResultUnknownMapper.ensureInitialized();
    }
    return _instance!;
  }
...
class SearchResultUnknownMapper
    extends SubClassMapperBase<SearchResultUnknown> {
  SearchResultUnknownMapper._();

  static SearchResultUnknownMapper? _instance;
  static SearchResultUnknownMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(_instance = SearchResultUnknownMapper._());
      SearchResultMapper.ensureInitialized().addSubMapper(_instance!);
    }
    return _instance!;
  }
  ...
  @override
  final String id = 'SearchResultUnknown';

  static Map<String, dynamic> _$json(SearchResultUnknown v) => v.json;
  static const Field<SearchResultUnknown, Map<String, dynamic>> _f$json = Field(
    'json',
    _$json,
  );

  @override
  final MappableFields<SearchResultUnknown> fields = const {#json: _f$json};
  ...
  static SearchResultUnknown _instantiate(DecodingData data) {
    return SearchResultUnknown(data.dec(_f$json));
  }

  @override
  final Function instantiate = _instantiate;

  static SearchResultUnknown fromJson(Map<String, dynamic> map) {
    return ensureInitialized().decodeMap<SearchResultUnknown>(map);
  }

  static SearchResultUnknown fromJsonString(String json) {
    return ensureInitialized().decodeJson<SearchResultUnknown>(json);
  }
}

mixin SearchResultUnknownMappable {
  String toJsonString() {
    return SearchResultUnknownMapper.ensureInitialized()
        .encodeJson<SearchResultUnknown>(this as SearchResultUnknown);
  }

  Map<String, dynamic> toJson() {
    return SearchResultUnknownMapper.ensureInitialized()
        .encodeMap<SearchResultUnknown>(this as SearchResultUnknown);
  }

  SearchResultUnknownCopyWith<
    SearchResultUnknown,
    SearchResultUnknown,
    SearchResultUnknown
  >
  get copyWith =>
      _SearchResultUnknownCopyWithImpl<
        SearchResultUnknown,
        SearchResultUnknown
      >(this as SearchResultUnknown, $identity, $identity);
  @override
  String toString() {
    return SearchResultUnknownMapper.ensureInitialized().stringifyValue(
      this as SearchResultUnknown,
    );
  }

  @override
  bool operator ==(Object other) {
    return SearchResultUnknownMapper.ensureInitialized().equalsValue(
      this as SearchResultUnknown,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return SearchResultUnknownMapper.ensureInitialized().hashValue(
      this as SearchResultUnknown,
    );
  }
}

extension SearchResultUnknownValueCopy<$R, $Out>
    on ObjectCopyWith<$R, SearchResultUnknown, $Out> {
  SearchResultUnknownCopyWith<$R, SearchResultUnknown, $Out>
  get $asSearchResultUnknown => $base.as(
    (v, t, t2) => _SearchResultUnknownCopyWithImpl<$R, $Out>(v, t, t2),
  );
}

abstract class SearchResultUnknownCopyWith<
  $R,
  $In extends SearchResultUnknown,
  $Out
>
    implements SearchResultCopyWith<$R, $In, $Out> {
  ...
  SearchResultUnknownCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(
    Then<$Out2, $R2> t,
  );
}

class _SearchResultUnknownCopyWithImpl<$R, $Out>
    extends ClassCopyWithBase<$R, SearchResultUnknown, $Out>
    implements SearchResultUnknownCopyWith<$R, SearchResultUnknown, $Out> {
  _SearchResultUnknownCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<SearchResultUnknown> $mapper =
      SearchResultUnknownMapper.ensureInitialized();
  @override
  MapCopyWith<$R, String, dynamic, ObjectCopyWith<$R, dynamic, dynamic>>
  ...
  @override
  SearchResultUnknown $make(CopyWithData data) =>
      SearchResultUnknown(data.get(#json, or: $value.json));

  @override
  SearchResultUnknownCopyWith<$R2, SearchResultUnknown, $Out2>
  $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
      _SearchResultUnknownCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
