...
class AuthOAuth {
  ...
  factory AuthOAuth.fromJson(Map<String, Object?> json) =>
      _$AuthOAuthFromJson(json);

  Map<String, Object?> toJson() => _$AuthOAuthToJson(this);
}
...
class AuthApiAuth {
  ...
  factory AuthApiAuth.fromJson(Map<String, Object?> json) =>
      _$AuthApiAuthFromJson(json);

  Map<String, Object?> toJson() => _$AuthApiAuthToJson(this);
}
...
class AuthWellKnownAuth {
  ...
  factory AuthWellKnownAuth.fromJson(Map<String, Object?> json) =>
      _$AuthWellKnownAuthFromJson(json);

  Map<String, Object?> toJson() => _$AuthWellKnownAuthToJson(this);
}
