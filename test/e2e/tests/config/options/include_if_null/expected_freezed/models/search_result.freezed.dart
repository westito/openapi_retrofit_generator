...
@JsonKey(includeIfNull: false) double? get score;
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( User user, @JsonKey(includeIfNull: false)  double? score)?  user,TResult Function( PostModel post, @JsonKey(includeIfNull: false)  double? score, @JsonKey(includeIfNull: false)  List<String>? highlights)?  post,TResult Function( Comment comment, @JsonKey(includeIfNull: false)  double? score)?  comment,required TResult orElse(),}) {final _that = this;
switch (_that) {
case SearchResultUser() when user != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( User user, @JsonKey(includeIfNull: false)  double? score)  user,required TResult Function( PostModel post, @JsonKey(includeIfNull: false)  double? score, @JsonKey(includeIfNull: false)  List<String>? highlights)  post,required TResult Function( Comment comment, @JsonKey(includeIfNull: false)  double? score)  comment,}) {final _that = this;
switch (_that) {
case SearchResultUser():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( User user, @JsonKey(includeIfNull: false)  double? score)?  user,TResult? Function( PostModel post, @JsonKey(includeIfNull: false)  double? score, @JsonKey(includeIfNull: false)  List<String>? highlights)?  post,TResult? Function( Comment comment, @JsonKey(includeIfNull: false)  double? score)?  comment,}) {final _that = this;
switch (_that) {
case SearchResultUser() when user != null:
return user(_that.user,_that.score);case SearchResultPost() when post != null:
return post(_that.post,_that.score,_that.highlights);case SearchResultComment() when comment != null:
...
class SearchResultUser implements SearchResult {
  const SearchResultUser({required this.user, @JsonKey(includeIfNull: false) this.score, final  String? $type}): $type = $type ?? 'user';
...
@override @useResult
$Res call({
 User user,@JsonKey(includeIfNull: false) double? score
});
...
class SearchResultPost implements SearchResult {
  const SearchResultPost({required this.post, @JsonKey(includeIfNull: false) this.score, @JsonKey(includeIfNull: false) final  List<String>? highlights, final  String? $type}): _highlights = highlights,$type = $type ?? 'post';
  factory SearchResultPost.fromJson(Map<String, dynamic> json) => _$SearchResultPostFromJson(json);

 final  PostModel post;
@override@JsonKey(includeIfNull: false) final  double? score;
 final  List<String>? _highlights;
@JsonKey(includeIfNull: false) List<String>? get highlights {
...
@override @useResult
$Res call({
 PostModel post,@JsonKey(includeIfNull: false) double? score,@JsonKey(includeIfNull: false) List<String>? highlights
});
...
class SearchResultComment implements SearchResult {
  const SearchResultComment({required this.comment, @JsonKey(includeIfNull: false) this.score, final  String? $type}): $type = $type ?? 'comment';
...
@override @useResult
$Res call({
 Comment comment,@JsonKey(includeIfNull: false) double? score
});
